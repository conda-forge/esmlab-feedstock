About esmlab-feedstock
======================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/esmlab-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/NCAR/esmlab

Documentation: https://esmlab.readthedocs.io/en/latest/
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=2491&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/esmlab-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `esmlab` can be installed with `conda`:
...
```
mamba install esmlab
```

It is possible to list all of the versions of `esmlab` available on your platform with `conda`:
...
```
mamba search esmlab --channel conda-forge
```
...
mamba repoquery search esmlab --channel conda-forge

# List packages depending on `esmlab`:
mamba repoquery whoneeds esmlab --channel conda-forge

# List dependencies of `esmlab`:
mamba repoquery depends esmlab --channel conda-forge
```
